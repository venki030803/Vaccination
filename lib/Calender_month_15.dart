...
class Calender_month15 extends StatefulWidget {
  final String username;

  Calender_month15({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_month15State createState() => _Calender_month15State();
}

class _Calender_month15State extends State<Calender_month15> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipformonth15completed_date;
    try {
