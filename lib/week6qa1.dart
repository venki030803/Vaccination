...
import 'package:medicalprojectflutter/week6qa2.dart';

class week6qa1 extends StatefulWidget {
  week6qa1(String userid);

  @override
  _week6qa1State createState() => _week6qa1State();
}

class _week6qa1State extends State<week6qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week6qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
