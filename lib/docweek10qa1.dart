...
import 'package:medicalprojectflutter/docweek10qa2.dart';

class docweek10qa1 extends StatefulWidget {
  final String username;
  const docweek10qa1({super.key, required this.username});
  @override
  _docweek10qa1State createState() => _docweek10qa1State();
}

class _docweek10qa1State extends State<docweek10qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek10qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Responds by smile and Responds to bell',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek10qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
