  ...
  class month15qa3 extends StatefulWidget {
    final String cmt;
    final String cmt1;
    month15qa3({Key? key, required this.cmt, required this.cmt1}) : super(key: key);
    
    @override
    _month15qa3State createState() => _month15qa3State();
  }

  class _month15qa3State extends State<month15qa3> {
    String cmt2 = "0"; // Default value for cmt
