...
import 'package:medicalprojectflutter/year5qa4.dart';

class year5qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  year5qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _year5qa3State createState() => _year5qa3State();
}

class _year5qa3State extends State<year5qa3> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Language :  Asks for meaning of words',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year5qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
