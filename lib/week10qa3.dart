...
import 'package:medicalprojectflutter/week10qa4.dart';

class week10qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  week10qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _week10qa3State createState() => _week10qa3State();
}

class _week10qa3State extends State<week10qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week10qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
