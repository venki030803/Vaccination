...
import 'package:medicalprojectflutter/docmonth9qa5.dart';

class docmonth9qa4 extends StatefulWidget {
  final String username;
  const docmonth9qa4({super.key, required this.username});
  @override
  _docmonth9qa4State createState() => _docmonth9qa4State();
}

class _docmonth9qa4State extends State<docmonth9qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth9qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
