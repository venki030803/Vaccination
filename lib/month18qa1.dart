...
import 'package:medicalprojectflutter/month18qa2.dart';

class month18qa1 extends StatefulWidget {
  month18qa1(String userid);

  @override
  _month18qa1State createState() => _month18qa1State();
}

class _month18qa1State extends State<month18qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month18qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
