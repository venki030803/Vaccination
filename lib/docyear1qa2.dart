...
import 'package:medicalprojectflutter/docyear1qa3.dart';

class docyear1qa2 extends StatefulWidget {
  final String username;
  const docyear1qa2({super.key, required this.username});
  @override
  _docyear1qa2State createState() => _docyear1qa2State();
}

class _docyear1qa2State extends State<docyear1qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear1qa2;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Fine motor : immature princeer grasp',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear1qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
