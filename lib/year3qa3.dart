...
import 'package:medicalprojectflutter/year3qa4.dart';

class year3qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  year3qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _year3qa3State createState() => _year3qa3State();
}

class _year3qa3State extends State<year3qa3> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Copies a circle, knows name or gender',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year3qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
