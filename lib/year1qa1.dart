...
import 'package:medicalprojectflutter/year1qa2.dart';

class year1qa1 extends StatefulWidget {
  year1qa1(String userid);

  @override
  _year1qa1State createState() => _year1qa1State();
}

class _year1qa1State extends State<year1qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year1qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
