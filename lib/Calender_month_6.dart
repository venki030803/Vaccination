...
class Calender_month6 extends StatefulWidget {
  final String username;

  Calender_month6({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_month6State createState() => _Calender_month6State();
}

class _Calender_month6State extends State<Calender_month6> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipformonth6completed_date;
    try {
