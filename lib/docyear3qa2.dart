...
import 'package:medicalprojectflutter/docyear3qa3.dart';

class docyear3qa2 extends StatefulWidget {
  final String username;
  const docyear3qa2({super.key, required this.username});
  @override
  _docyear3qa2State createState() => _docyear3qa2State();
}

class _docyear3qa2State extends State<docyear3qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear3qa2;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Tower of 8 cubes , making a bridge/gate of 3 cubes',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear3qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
