...
class week14qa4 extends StatefulWidget {
  final String cmt;
  final String cmt1;
  final String cmt2;
  week14qa4({Key? key, required this.cmt, required this.cmt1, required this.cmt2}) : super(key: key);
  
  @override
  _week14qa4State createState() => _week14qa4State();
}

class _week14qa4State extends State<week14qa4> {
