...
import 'package:medicalprojectflutter/docyear5qa4.dart';

class docyear5qa3 extends StatefulWidget {
  final String username;
  const docyear5qa3({super.key, required this.username});
  @override
  _docyear5qa3State createState() => _docyear5qa3State();
}

class _docyear5qa3State extends State<docyear5qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear5qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
