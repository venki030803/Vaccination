...
class docweek14qa4 extends StatefulWidget {
  final String username;
  const docweek14qa4({super.key, required this.username});
  @override
  _docweek14qa4State createState() => _docweek14qa4State();
}

class _docweek14qa4State extends State<docweek14qa4> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek14qa4;
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Fine motor : Bi - Dextrous approach , Full head control',
