...
import 'package:medicalprojectflutter/year5qa3.dart';

class year5qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  year5qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _year5qa2State createState() => _year5qa2State();
}

class _year5qa2State extends State<year5qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year5qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
