...
import 'package:medicalprojectflutter/year1qa4.dart';

class year1qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  year1qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _year1qa3State createState() => _year1qa3State();
}

class _year1qa3State extends State<year1qa3> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Social :waves bye - bye plays - peak a boo, claps ',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year1qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
