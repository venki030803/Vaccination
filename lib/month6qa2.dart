...
import 'package:medicalprojectflutter/month6qa3.dart';

class month6qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  month6qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _month6qa2State createState() => _month6qa2State();
}

class _month6qa2State extends State<month6qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month6qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
