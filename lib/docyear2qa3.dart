...
import 'package:medicalprojectflutter/docyear2qa4.dart';

class docyear2qa3 extends StatefulWidget {
  final String username;
  const docyear2qa3({super.key, required this.username});
  @override
  _docyear2qa3State createState() => _docyear2qa3State();
}

class _docyear2qa3State extends State<docyear2qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear2qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
