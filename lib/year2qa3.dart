...
import 'package:medicalprojectflutter/year2qa4.dart';

class year2qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  year2qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _year2qa3State createState() => _year2qa3State();
}

class _year2qa3State extends State<year2qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year2qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
