...
import 'package:medicalprojectflutter/month9qa4.dart';

class month9qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  month9qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _month9qa3State createState() => _month9qa3State();
}

class _month9qa3State extends State<month9qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>month9qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
