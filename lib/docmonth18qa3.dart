...
import 'package:medicalprojectflutter/docmonth18qa4.dart';

class docmonth18qa3 extends StatefulWidget {
  final String username;
  const docmonth18qa3({super.key, required this.username});
  @override
  _docmonth18qa3State createState() => _docmonth18qa3State();
}

class _docmonth18qa3State extends State<docmonth18qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth18qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
