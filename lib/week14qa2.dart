...
import 'package:medicalprojectflutter/week14qa3.dart';

class week14qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  week14qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _week14qa2State createState() => _week14qa2State();
}

class _week14qa2State extends State<week14qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week14qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
