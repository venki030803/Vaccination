...
import 'package:medicalprojectflutter/docmonth6qa2.dart';

class docmonth6qa1 extends StatefulWidget {
  final String username;
  const docmonth6qa1({super.key, required this.username});
  @override
  _docmonth6qa1State createState() => _docmonth6qa1State();
}

class _docmonth6qa1State extends State<docmonth6qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth6qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Prone position - lifts the chin and chest,while  supporiing weight,on extended arms',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth6qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
