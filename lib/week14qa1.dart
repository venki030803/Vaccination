...
import 'package:medicalprojectflutter/week14qa2.dart';

class week14qa1 extends StatefulWidget {
  week14qa1(String userid);

  @override
  _week14qa1State createState() => _week14qa1State();
}

class _week14qa1State extends State<week14qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week14qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
