...
import 'package:medicalprojectflutter/year2qa3.dart';

class year2qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  year2qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _year2qa2State createState() => _year2qa2State();
}

class _year2qa2State extends State<year2qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year2qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
