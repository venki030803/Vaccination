...
import 'package:medicalprojectflutter/docweek14qa3.dart';

class docweek14qa2 extends StatefulWidget {
  final String username;
  const docweek14qa2({super.key, required this.username});
  @override
  _docweek14qa2State createState() => _docweek14qa2State();
}

class _docweek14qa2State extends State<docweek14qa2> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Prone position - Face,head and chest of the couch',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek14qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
