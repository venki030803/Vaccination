...
import 'package:medicalprojectflutter/docmonth18qa2.dart';

class docmonth18qa1 extends StatefulWidget {
  final String username;
  const docmonth18qa1({super.key, required this.username});
  @override
  _docmonth18qa1State createState() => _docmonth18qa1State();
}

class _docmonth18qa1State extends State<docmonth18qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth18qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Runs,explores table drawers, Domestic mimicry,8 - 10 words',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth18qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
