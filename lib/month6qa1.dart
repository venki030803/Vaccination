...
import 'package:medicalprojectflutter/month6qa2.dart';

class month6qa1 extends StatefulWidget {
  month6qa1(String userid);

  @override
  _month6qa1State createState() => _month6qa1State();
}

class _month6qa1State extends State<month6qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month6qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
