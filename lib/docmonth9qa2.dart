...
import 'package:medicalprojectflutter/docmonth9qa3.dart';

class docmonth9qa2 extends StatefulWidget {
  final String username;
  const docmonth9qa2({super.key, required this.username});
  @override
  _docmonth9qa2State createState() => _docmonth9qa2State();
}

class _docmonth9qa2State extends State<docmonth9qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth9qa2;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Mature pincer grasp,plays simple ball game',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth9qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
