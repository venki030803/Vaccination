...
import 'package:medicalprojectflutter/docyear3qa5.dart';

class docyear3qa4 extends StatefulWidget {
  final String username;
  const docyear3qa4({super.key, required this.username});
  @override
  _docyear3qa4State createState() => _docyear3qa4State();
}

class _docyear3qa4State extends State<docyear3qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear3qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
