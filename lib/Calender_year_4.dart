...
class Calender_year_4 extends StatefulWidget {
  final String username;

  Calender_year_4({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_year_4State createState() => _Calender_year_4State();
}

class _Calender_year_4State extends State<Calender_year_4> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforyear4completed_date;
    try {
