...
import 'package:medicalprojectflutter/year5qa5.dart';

class year5qa4 extends StatefulWidget {
  final String cmt; final String cmt1; final String cmt2;
  // Define a field to receive cmt
  year5qa4({Key? key, required this.cmt, required this.cmt1,required this.cmt2}) : super(key: key); // Constructor

  @override
  _year5qa4State createState() => _year5qa4State();
}

class _year5qa4State extends State<year5qa4> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Identify and write letter A,B,C,1,2,3,4',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year5qa5(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: widget.cmt2,cmt3 : cmt3)),
                  );
                },
                child: Image.asset(
