...
class Calender_month18 extends StatefulWidget {
  final String username;

  Calender_month18({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_month18State createState() => _Calender_month18State();
}

class _Calender_month18State extends State<Calender_month18> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipformonth18completed_date;
    try {
