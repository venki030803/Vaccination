...
class week10qa4 extends StatefulWidget {
  final String cmt;
  final String cmt1;
  final String cmt2;
  week10qa4({Key? key, required this.cmt, required this.cmt1, required this.cmt2}) : super(key: key);
  
  @override
  _week10qa4State createState() => _week10qa4State();
}

class _week10qa4State extends State<week10qa4> {
