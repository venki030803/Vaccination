...
class Calender_year_3 extends StatefulWidget {
  final String username;

  Calender_year_3({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_year_3State createState() => _Calender_year_3State();
}

class _Calender_year_3State extends State<Calender_year_3> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforyear3completed_date;
    try {
