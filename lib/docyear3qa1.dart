...
import 'package:medicalprojectflutter/docyear3qa2.dart';

class docyear3qa1 extends StatefulWidget {
  final String username;
  const docyear3qa1({super.key, required this.username});
  @override
  _docyear3qa1State createState() => _docyear3qa1State();
}

class _docyear3qa1State extends State<docyear3qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear3qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Rides tricyce,Alternate feet going  upstairs,3 word sentence',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear3qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
