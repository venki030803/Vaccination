...
import 'package:medicalprojectflutter/docyear1qa2.dart';

class docyear1qa1 extends StatefulWidget {
  final String username;
  const docyear1qa1({super.key, required this.username});
  @override
  _docyear1qa1State createState() => _docyear1qa1State();
}

class _docyear1qa1State extends State<docyear1qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear1qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Gross motor : Sits well stands holding on (with support)',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear1qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
