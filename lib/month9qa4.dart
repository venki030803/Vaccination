...
import 'package:medicalprojectflutter/month9qa5.dart';

class month9qa4 extends StatefulWidget {
  final String cmt; final String cmt1; final String cmt2;
  // Define a field to receive cmt
  month9qa4({Key? key, required this.cmt, required this.cmt1,required this.cmt2}) : super(key: key); // Constructor

  @override
  _month9qa4State createState() => _month9qa4State();
}

class _month9qa4State extends State<month9qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>month9qa5(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: widget.cmt2,cmt3 : cmt3)),
                  );
                },
                child: Image.asset(
