...
import 'package:medicalprojectflutter/docmonth15qa2.dart';

class docmonth15qa1 extends StatefulWidget {
  final String username;
  const docmonth15qa1({super.key, required this.username});
  @override
  _docmonth15qa1State createState() => _docmonth15qa1State();
}

class _docmonth15qa1State extends State<docmonth15qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth15qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Walks alone,Crawls upstairs, imitates as taking by phone',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth15qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
