...
import 'package:medicalprojectflutter/week6qa3.dart';

class week6qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  week6qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _week6qa2State createState() => _week6qa2State();
}

class _week6qa2State extends State<week6qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week6qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
