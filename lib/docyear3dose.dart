...
class docyear3dose extends StatefulWidget {
  final String username;
  
  const docyear3dose({Key? key, required this.username}) : super(key: key);

  @override
  State<docyear3dose> createState() => _docyear3doseState();
}

class _docyear3doseState extends State<docyear3dose> {
  int q1 = 0;
  int d = 0;
  int a = 0;
  int b = 0;
  ...
  final String url = ipforyear3dose;
