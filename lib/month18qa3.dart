...
import 'package:medicalprojectflutter/month18qa4.dart';

class month18qa3 extends StatefulWidget {
  final String cmt; final String cmt1;
  // Define a field to receive cmt
  month18qa3({Key? key, required this.cmt, required this.cmt1,}) : super(key: key); // Constructor

  @override
  _month18qa3State createState() => _month18qa3State();
}

class _month18qa3State extends State<month18qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>month18qa4(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: cmt2,)),
                  );
                },
                child: Image.asset(
