...
import 'package:medicalprojectflutter/month15qa3.dart';

class month15qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  month15qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _month15qa2State createState() => _month15qa2State();
}

class _month15qa2State extends State<month15qa2> {
  // String cmt = "0"; // No need for this as cmt is now received from month15qa1
  String cmt1="0";
  void fetchData() async {
    // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
    String apiUrl = ipformonth15qa2;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month15qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
