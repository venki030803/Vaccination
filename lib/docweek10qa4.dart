...
class docweek10qa4 extends StatefulWidget {
  final String username;
  const docweek10qa4({super.key, required this.username});
  @override
  _docweek10qa4State createState() => _docweek10qa4State();
}

class _docweek10qa4State extends State<docweek10qa4> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek10qa4;
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Begin to recognize the mother face',
