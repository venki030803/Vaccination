...
import 'package:medicalprojectflutter/docmonth9qa4.dart';

class docmonth9qa3 extends StatefulWidget {
  final String username;
  const docmonth9qa3({super.key, required this.username});
  @override
  _docmonth9qa3State createState() => _docmonth9qa3State();
}

class _docmonth9qa3State extends State<docmonth9qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth9qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
