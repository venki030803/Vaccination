...
import 'package:medicalprojectflutter/year2qa2.dart';

class year2qa1 extends StatefulWidget {
  year2qa1(String userid);

  @override
  _year2qa1State createState() => _year2qa1State();
}

class _year2qa1State extends State<year2qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year2qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
