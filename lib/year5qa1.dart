...
import 'package:medicalprojectflutter/year5qa2.dart';

class year5qa1 extends StatefulWidget {
  year5qa1(String userid);

  @override
  _year5qa1State createState() => _year5qa1State();
}

class _year5qa1State extends State<year5qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year5qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
