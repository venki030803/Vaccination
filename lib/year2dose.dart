...
import 'package:medicalprojectflutter/Calender_year_2.dart';
...
class year2dose extends StatefulWidget {
  @override
  State<year2dose> createState() => _year2doseState();
}

class _year2doseState extends State<year2dose> {
  List<int> array = [0,0];
  ...
  void handleResponses(String response, String username) {
    ...
    if (values[1].substring(0, values[1].length - 1) == "0") {
      ...
      if (days > 0) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Calender_year_2(username: userid)),
        );
      }
    } else {
      showDialog(
