...
import 'package:medicalprojectflutter/docmonth6qa3.dart';

class docmonth6qa2 extends StatefulWidget {
  final String username;
  const docmonth6qa2({super.key, required this.username});
  @override
  _docmonth6qa2State createState() => _docmonth6qa2State();
}

class _docmonth6qa2State extends State<docmonth6qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth6qa2;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Sits with support and like to look itself in a mirror',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth6qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
