...
import 'package:medicalprojectflutter/docyear2qa3.dart';

class docyear2qa2 extends StatefulWidget {
  final String username;
  const docyear2qa2({super.key, required this.username});
  @override
  _docyear2qa2State createState() => _docyear2qa2State();
}

class _docyear2qa2State extends State<docyear2qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear2qa2;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Walks up and down stairs(2 feet/step)',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear2qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
