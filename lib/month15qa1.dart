...
import 'package:medicalprojectflutter/month15qa2.dart';

class month15qa1 extends StatefulWidget {
  month15qa1(String userid);

  @override
  _month15qa1State createState() => _month15qa1State();
}

class _month15qa1State extends State<month15qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month15qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
