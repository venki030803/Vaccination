...
import 'package:medicalprojectflutter/year1qa5.dart';

class year1qa4 extends StatefulWidget {
  final String cmt; final String cmt1; final String cmt2;
  // Define a field to receive cmt
  year1qa4({Key? key, required this.cmt, required this.cmt1,required this.cmt2}) : super(key: key); // Constructor

  @override
  _year1qa4State createState() => _year1qa4State();
}

class _year1qa4State extends State<year1qa4> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Language : says bi-syllables mama,baba,dada',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>year1qa5(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: widget.cmt2,cmt3 : cmt3)),
                  );
                },
                child: Image.asset(
