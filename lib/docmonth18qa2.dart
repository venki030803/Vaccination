...
import 'package:medicalprojectflutter/docmonth18qa3.dart';

class docmonth18qa2 extends StatefulWidget {
  final String username;
  const docmonth18qa2({super.key, required this.username});
  @override
  _docmonth18qa2State createState() => _docmonth18qa2State();
}

class _docmonth18qa2State extends State<docmonth18qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth18qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
