...
import 'package:medicalprojectflutter/docweek10qa3.dart';

class docweek10qa2 extends StatefulWidget {
  final String username;
  const docweek10qa2({super.key, required this.username});
  @override
  _docweek10qa2State createState() => _docweek10qa2State();
}

class _docweek10qa2State extends State<docweek10qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek10qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
