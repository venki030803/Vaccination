...
import 'package:medicalprojectflutter/docyear5qa2.dart';

class docyear5qa1 extends StatefulWidget {
  final String username;
  const docyear5qa1({super.key, required this.username});
  @override
  _docyear5qa1State createState() => _docyear5qa1State();
}

class _docyear5qa1State extends State<docyear5qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear5qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Plays skipping rope,copies a triangle,steps tof 10 cubes,Count upto 10',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear5qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
