...
import 'package:medicalprojectflutter/docweek6qa2.dart';

class docweek6qa1 extends StatefulWidget {
  final String username;
  const docweek6qa1({super.key, required this.username});
  @override
  _docweek6qa1State createState() => _docweek6qa1State();
}

class _docweek6qa1State extends State<docweek6qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek6qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Momentarily holds the head in horizontal plane',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek6qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
