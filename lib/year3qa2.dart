...
import 'package:medicalprojectflutter/year3qa3.dart';

class year3qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  year3qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _year3qa2State createState() => _year3qa2State();
}

class _year3qa2State extends State<year3qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year3qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
