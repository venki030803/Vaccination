...
import 'package:medicalprojectflutter/month9qa2.dart';

class month9qa1 extends StatefulWidget {
  month9qa1(String userid);

  @override
  _month9qa1State createState() => _month9qa1State();
}

class _month9qa1State extends State<month9qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month9qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
