...
import 'package:medicalprojectflutter/docyear4qa4.dart';

class docyear4qa3 extends StatefulWidget {
  final String username;
  const docyear4qa3({super.key, required this.username});
  @override
  _docyear4qa3State createState() => _docyear4qa3State();
}

class _docyear4qa3State extends State<docyear4qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear4qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
