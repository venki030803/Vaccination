...
class docyear5dose extends StatefulWidget {
  final String username;
  
  const docyear5dose({Key? key, required this.username}) : super(key: key);

  @override
  State<docyear5dose> createState() => _docyear5doseState();
}

class _docyear5doseState extends State<docyear5dose> {
  int q1 = 0;
  int q2 = 0;
  int q3 = 0;
  int q4 = 0;
  ...
  final String url = ipforyear5dose;
  final String apiUrl = ipforyear5doseshow;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        buildListItem('DTwp-B1/DTap - B2', () {
                          setState(() {
                            q1 = 1;
                          });
                        }, q1),
                        buildListItem('IPV - B2', () {
                          setState(() {
                            q2 = 1;
                          });
                        }, q2),
