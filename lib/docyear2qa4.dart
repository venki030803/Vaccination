...
import 'package:medicalprojectflutter/docyear2qa5.dart';

class docyear2qa4 extends StatefulWidget {
  final String username;
  const docyear2qa4({super.key, required this.username});
  @override
  _docyear2qa4State createState() => _docyear2qa4State();
}

class _docyear2qa4State extends State<docyear2qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear2qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
