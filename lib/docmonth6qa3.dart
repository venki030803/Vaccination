...
import 'package:medicalprojectflutter/docmonth6qa4.dart';

class docmonth6qa3 extends StatefulWidget {
  final String username;
  const docmonth6qa3({super.key, required this.username});
  @override
  _docmonth6qa3State createState() => _docmonth6qa3State();
}

class _docmonth6qa3State extends State<docmonth6qa3> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth6qa3;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth6qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
