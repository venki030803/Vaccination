...
import 'package:medicalprojectflutter/docyear2qa2.dart';

class docyear2qa1 extends StatefulWidget {
  final String username;
  const docyear2qa1({super.key, required this.username});
  @override
  _docyear2qa1State createState() => _docyear2qa1State();
}

class _docyear2qa1State extends State<docyear2qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear2qa1;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear2qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
