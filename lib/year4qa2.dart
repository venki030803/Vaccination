...
import 'package:medicalprojectflutter/year4qa3.dart';

class year4qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  year4qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _year4qa2State createState() => _year4qa2State();
}

class _year4qa2State extends State<year4qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year4qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
