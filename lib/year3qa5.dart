...
class year3qa5 extends StatefulWidget {
  final String cmt;
  final String cmt1;
  final String cmt2;
  final String cmt3;
  year3qa5({Key? key, required this.cmt, required this.cmt1, required this.cmt2, required this.cmt3}) : super(key: key);
  
  @override
  _year3qa5State createState() => _year3qa5State();
}

class _year3qa5State extends State<year3qa5> {
  String cmt4 = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear3qa5;
