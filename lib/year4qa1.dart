...
import 'package:medicalprojectflutter/year4qa2.dart';

class year4qa1 extends StatefulWidget {
  year4qa1(String userid);

  @override
  _year4qa1State createState() => _year4qa1State();
}

class _year4qa1State extends State<year4qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year4qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
