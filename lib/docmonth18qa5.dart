...
class docmonth18qa5 extends StatefulWidget {
  final String username;
  const docmonth18qa5({super.key, required this.username});
  @override
  _docmonth18qa5State createState() => _docmonth18qa5State();
}

class _docmonth18qa5State extends State<docmonth18qa5> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth18qa5;
