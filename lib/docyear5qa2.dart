...
import 'package:medicalprojectflutter/docyear5qa3.dart';

class docyear5qa2 extends StatefulWidget {
  final String username;
  const docyear5qa2({super.key, required this.username});
  @override
  _docyear5qa2State createState() => _docyear5qa2State();
}

class _docyear5qa2State extends State<docyear5qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear5qa2;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear5qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
