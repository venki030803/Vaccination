...
class docmonth15dose extends StatefulWidget {
  final String username;
  
  const docmonth15dose({Key? key, required this.username}) : super(key: key);

  @override
  State<docmonth15dose> createState() => _docmonth15doseState();
}

class _docmonth15doseState extends State<docmonth15dose> {
  int q1 = 0;
  int q2 = 0;
  int a = 0;
  int b = 0;
  ...
  final String url = ipformonth15dose;
  final String apiUrl = ipformonth15doseshow;
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...
                        buildListItem('Varicella - Dose 1', () {
                          setState(() {
                            q2 = 1;
                          });
                        }, q2),
                        buildListItem('PCV Booster', () {
