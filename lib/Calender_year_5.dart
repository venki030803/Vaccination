...
class Calender_year_5 extends StatefulWidget {
  final String username;

  Calender_year_5({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_year_5State createState() => _Calender_year_5State();
}

class _Calender_year_5State extends State<Calender_year_5> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforyear5completed_date;
    try {
