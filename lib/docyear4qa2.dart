...
import 'package:medicalprojectflutter/docyear4qa3.dart';

class docyear4qa2 extends StatefulWidget {
  final String username;
  const docyear4qa2({super.key, required this.username});
  @override
  _docyear4qa2State createState() => _docyear4qa2State();
}

class _docyear4qa2State extends State<docyear4qa2> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear4qa2;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear4qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
