...
import 'package:medicalprojectflutter/docmonth9qa2.dart';

class docmonth9qa1 extends StatefulWidget {
  final String username;
  const docmonth9qa1({super.key, required this.username});
  @override
  _docmonth9qa1State createState() => _docmonth9qa1State();
}

class _docmonth9qa1State extends State<docmonth9qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth9qa1;
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Stands without support.Walks alone, but falls',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth9qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
