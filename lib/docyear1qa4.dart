...
import 'package:medicalprojectflutter/docyear1qa5.dart';

class docyear1qa4 extends StatefulWidget {
  final String username;
  const docyear1qa4({super.key, required this.username});
  @override
  _docyear1qa4State createState() => _docyear1qa4State();
}

class _docyear1qa4State extends State<docyear1qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear1qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
