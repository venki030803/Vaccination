...
class Calender_10 extends StatefulWidget {
  final String username;

  Calender_10({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_10State createState() => _Calender_10State();
}

class _Calender_10State extends State<Calender_10> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforweek10completed_date;
    try {
