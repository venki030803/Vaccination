...
import 'package:medicalprojectflutter/docweek10qa4.dart';

class docweek10qa3 extends StatefulWidget {
  final String username;
  const docweek10qa3({super.key, required this.username});
  @override
  _docweek10qa3State createState() => _docweek10qa3State();
}

class _docweek10qa3State extends State<docweek10qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek10qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
