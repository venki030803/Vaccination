...
class docyear4dose extends StatefulWidget {
  final String username;
  
  const docyear4dose({Key? key, required this.username}) : super(key: key);

  @override
  State<docyear4dose> createState() => _docyear4doseState();
}

class _docyear4doseState extends State<docyear4dose> {
  int q1 = 0;
  int d = 0;
  int a = 0;
  int b = 0;
  ...
  final String url = ipforyear4dose;
