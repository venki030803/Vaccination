...
import 'package:medicalprojectflutter/month18qa5.dart';

class month18qa4 extends StatefulWidget {
  final String cmt; final String cmt1; final String cmt2;
  // Define a field to receive cmt
  month18qa4({Key? key, required this.cmt, required this.cmt1,required this.cmt2}) : super(key: key); // Constructor

  @override
  _month18qa4State createState() => _month18qa4State();
}

class _month18qa4State extends State<month18qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>month18qa5(cmt: widget.cmt,cmt1:widget.cmt1, cmt2: widget.cmt2,cmt3 : cmt3)),
                  );
                },
                child: Image.asset(
