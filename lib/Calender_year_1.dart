...
class Calender_year_1 extends StatefulWidget {
  final String username;

  Calender_year_1({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_year_1State createState() => _Calender_year_1State();
}

class _Calender_year_1State extends State<Calender_year_1> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforyear1completed_date;
    try {
