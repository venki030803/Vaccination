...
import 'package:medicalprojectflutter/docyear5qa5.dart';

class docyear5qa4 extends StatefulWidget {
  final String username;
  const docyear5qa4({super.key, required this.username});
  @override
  _docyear5qa4State createState() => _docyear5qa4State();
}

class _docyear5qa4State extends State<docyear5qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear5qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
