...
import 'package:medicalprojectflutter/docmonth18qa5.dart';

class docmonth18qa4 extends StatefulWidget {
  final String username;
  const docmonth18qa4({super.key, required this.username});
  @override
  _docmonth18qa4State createState() => _docmonth18qa4State();
}

class _docmonth18qa4State extends State<docmonth18qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth18qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
