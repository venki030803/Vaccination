...
class docweek6qa3 extends StatefulWidget {
  final String username;
  const docweek6qa3({super.key, required this.username});
  @override
  _docweek6qa3State createState() => _docweek6qa3State();
}

class _docweek6qa3State extends State<docweek6qa3> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek6qa3;
