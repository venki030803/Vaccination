...
import 'package:medicalprojectflutter/year3qa2.dart';

class year3qa1 extends StatefulWidget {
  year3qa1(String userid);

  @override
  _year3qa1State createState() => _year3qa1State();
}

class _year3qa1State extends State<year3qa1> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year3qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
