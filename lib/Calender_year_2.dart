...
class Calender_year_2 extends StatefulWidget {
  final String username;

  Calender_year_2({Key? key, required this.username}) : super(key: key);

  @override
  _Calender_year_2State createState() => _Calender_year_2State();
}

class _Calender_year_2State extends State<Calender_year_2> {
  late String mdate;
  ...
  Future<void> sendLoginRequest(String username, String date) async {
    final url = ipforyear2completed_date;
    try {
