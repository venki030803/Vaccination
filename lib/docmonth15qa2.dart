...
import 'package:medicalprojectflutter/docmonth15qa3.dart';

class docmonth15qa2 extends StatefulWidget {
  final String username;
  const docmonth15qa2({super.key, required this.username});
  @override
  _docmonth15qa2State createState() => _docmonth15qa2State();
}

class _docmonth15qa2State extends State<docmonth15qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docmonth15qa3( username: widget.username,)),
                  );
                },
                child: Image.asset(
