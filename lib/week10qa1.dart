...
import 'package:medicalprojectflutter/week10qa2.dart';

class week10qa1 extends StatefulWidget {
  week10qa1(String userid);

  @override
  _week10qa1State createState() => _week10qa1State();
}

class _week10qa1State extends State<week10qa1> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Responds by smile and Reeponds to bell',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => week10qa2(cmt: cmt)),
                  );
                },
                child: Image.asset(
