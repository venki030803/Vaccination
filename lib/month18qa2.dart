...
import 'package:medicalprojectflutter/month18qa3.dart';

class month18qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  month18qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _month18qa2State createState() => _month18qa2State();
}

class _month18qa2State extends State<month18qa2> {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Throws a ball without falling,Recgnize parts of the body',
                        style: TextStyle(
                          fontSize: 20,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month18qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
