...
class docyear2qa5 extends StatefulWidget {
  final String username;
  const docyear2qa5({super.key, required this.username});
  @override
  _docyear2qa5State createState() => _docyear2qa5State();
}

class _docyear2qa5State extends State<docyear2qa5> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear2qa5;
