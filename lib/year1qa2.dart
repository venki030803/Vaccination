...
import 'package:medicalprojectflutter/year1qa3.dart';

class year1qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  year1qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _year1qa2State createState() => _year1qa2State();
}

class _year1qa2State extends State<year1qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => year1qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
