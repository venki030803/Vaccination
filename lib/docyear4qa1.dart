...
import 'package:medicalprojectflutter/docyear4qa2.dart';

class docyear4qa1 extends StatefulWidget {
  final String username;
  const docyear4qa1({super.key, required this.username});
  @override
  _docyear4qa1State createState() => _docyear4qa1State();
}

class _docyear4qa1State extends State<docyear4qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforyear4qa1;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear4qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
