...
import 'package:medicalprojectflutter/docyear4qa5.dart';

class docyear4qa4 extends StatefulWidget {
  final String username;
  const docyear4qa4({super.key, required this.username});
  @override
  _docyear4qa4State createState() => _docyear4qa4State();
}

class _docyear4qa4State extends State<docyear4qa4> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear4qa5( username: widget.username,)),
                  );
                },
                child: Image.asset(
