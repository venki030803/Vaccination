...
import 'package:medicalprojectflutter/docyear3qa4.dart';

class docyear3qa3 extends StatefulWidget {
  final String username;
  const docyear3qa3({super.key, required this.username});
  @override
  _docyear3qa3State createState() => _docyear3qa3State();
}

class _docyear3qa3State extends State<docyear3qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear3qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
