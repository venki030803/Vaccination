...
class month6qa4 extends StatefulWidget {
  final String cmt;
  final String cmt1;
  final String cmt2;
  month6qa4({Key? key, required this.cmt, required this.cmt1, required this.cmt2}) : super(key: key);
  
  @override
  _month6qa4State createState() => _month6qa4State();
}

class _month6qa4State extends State<month6qa4> {
  String cmt3 = "0"; // Default value for cmt
