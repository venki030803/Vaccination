  ...
  class week6qa3 extends StatefulWidget {
    final String cmt;
    final String cmt1;
    week6qa3({Key? key, required this.cmt, required this.cmt1}) : super(key: key);
    
    @override
    _week6qa3State createState() => _week6qa3State();
  }

  class _week6qa3State extends State<week6qa3> {
