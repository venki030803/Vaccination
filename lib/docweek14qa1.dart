...
import 'package:medicalprojectflutter/docweek14qa2.dart';

class docweek14qa1 extends StatefulWidget {
  final String username;
  const docweek14qa1({super.key, required this.username});
  @override
  _docweek14qa1State createState() => _docweek14qa1State();
}

class _docweek14qa1State extends State<docweek14qa1> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipforweek14qa1;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docweek14qa2( username: widget.username,)),
                  );
                },
                child: Image.asset(
