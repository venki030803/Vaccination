...
import 'package:medicalprojectflutter/docyear1qa4.dart';

class docyear1qa3 extends StatefulWidget {
  final String username;
  const docyear1qa3({super.key, required this.username});
  @override
  _docyear1qa3State createState() => _docyear1qa3State();
}

class _docyear1qa3State extends State<docyear1qa3> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => docyear1qa4( username: widget.username,)),
                  );
                },
                child: Image.asset(
