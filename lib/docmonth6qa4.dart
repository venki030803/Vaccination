...
class docmonth6qa4 extends StatefulWidget {
  final String username;
  const docmonth6qa4({super.key, required this.username});
  @override
  _docmonth6qa4State createState() => _docmonth6qa4State();
}

class _docmonth6qa4State extends State<docmonth6qa4> {
  String cmt = "0"; // Default value for cmt

  void fetchData() async {
    String apiUrl = ipformonth6qa4;
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Fine Motor : Transfer objects Holds cube crudely -Uni -dexterous',
