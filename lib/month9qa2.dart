...
import 'package:medicalprojectflutter/month9qa3.dart';

class month9qa2 extends StatefulWidget {
  final String cmt; 
  // Define a field to receive cmt
  month9qa2({Key? key, required this.cmt}) : super(key: key); // Constructor

  @override
  _month9qa2State createState() => _month9qa2State();
}

class _month9qa2State extends State<month9qa2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => month9qa3(cmt: widget.cmt,cmt1: cmt1)),
                  );
                },
                child: Image.asset(
