...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO week7qa (username, q1, q2, q3,q4) VALUES ('$username', '0', '0', '0', '0')";
        $insertStmt = $conn->query($insertSql);
        $insertSql2 = "INSERT INTO week7dose (username, q1, q2, q3,q4,q5,q6) VALUES ('$username', '0', '0', '0','0','0','0')";
